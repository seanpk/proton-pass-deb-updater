...
This script is motivated out of the dread and frustration caused whenever the Proton Pass app starts nagging for an update, e.g.:

<img width="789" height="140" alt="image" src="https://github.com/user-attachments/assets/5a8dcd4d-edb0-4863-b206-2f479c94a76c" />

Now when it nags, just run this script and restart it. 

As you can imagine, this is NOT an officially supported script from Proton AG.
...
<img width="848" height="579" alt="image" src="https://github.com/user-attachments/assets/c7bbca02-5629-4842-be74-66f2cab2bdc1" />
